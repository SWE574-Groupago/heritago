...
class APITests(unittest.TestCase):
    ...
    def test_heritages_get_multimedia_of_a_heritage_item(self):
        """ ENDPOINT: api/heritages/{hid}/multimedia,
            METHOD: GET,
            CONDITION: heritage item exists with no multimedia,
            EXPECTING: empty multimedia """
    ...
    def test_heritages_try_to_get_non_existing_heritage_items_multimedia(self):
        """ ENDPOINT: api/heritages/{hid}/multimedia,
            METHOD: GET,
            CONDITION: heritage item does not exist,
            EXPECTING: empty multimedia """
    ...
    def test_heritages_try_to_create_non_existing_heritage_item_a_multimedia(self):
        """ ENDPOINT: api/heritages/{hid}/multimedia,
            METHOD: POST,
            CONDITION: create a multimedia for a heritage item that does not exist,
            EXPECTING: StatusCode:404 """
    ...
    def test_heritages_add_multimedia_to_heritage_item(self):
        """ ENDPOINT: api/heritages/{hid}/multimedia,
            METHOD: POST,
            CONDITION: create heritage item and add media to it,
            EXPECTING: StatusCode:201 """
