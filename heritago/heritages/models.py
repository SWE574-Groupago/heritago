...
class Annotation(models.Model):
    ...
    annotation_id = models.URLField(primary_key=True, max_length=255, default="http://574heritago.com/annotations/null/")
    body = models.ForeignKey(to=AnnotationBody, related_name="body")
    target = models.ForeignKey(to=AnnotationTarget, related_name="target")
