((function() {
    var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q = Array.prototype.slice,
        ...
        t = function(a, b) {
            ...
            for (var c in b) r.call(b, c) && (a[c] = b[c]);
            return d.prototype = b.prototype, a.prototype = new d, a.__super__ = b.prototype, a
        };
    g = null, typeof Gettext != "undefined" && Gettext !== null ? (j = new Gettext({
        domain: "annotator"
    }), g = function(a) {
        return j.gettext(a)
    }) : g = function(a) {
    ...
    }, f = ["log", "debug", "info", "warn", "exception", "assert", "dir", "dirxml", "trace", "group", "groupEnd", "groupCollapsed", "time", "timeEnd", "profile", "profileEnd", "count", "clear", "table", "error", "notifyFirebug", "firebug", "userObjects"];
    if (typeof console != "undefined" && console !== null) {
        ...
        for (k = 0, m = f.length; k < m; k++) e = f[k], console[e] == null && (console[e] = function() {
            return console.log(p("Not implemented:") + (" console." + name))
        })
    } else {
        this.console = {};
        for (l = 0, n = f.length; l < n; l++) e = f[l], this.console[e] = function() {};
        this.console.error = function() {
            var a;
            return a = 1 <= arguments.length ? q.call(arguments, 0) : [], alert("ERROR: " + a.join(", "))
        }, this.console.warn = function() {
            var a;
            return a = 1 <= arguments.length ? q.call(arguments, 0) : [], alert("WARNING: " + a.join(", "))
        }
    }
    c = function() {
        function b(b, c) {
        ...
        return b.prototype.events = {}, b.prototype.options = {}, b.prototype.element = null, b.prototype.addEvents = function() {
            var a, b, c, d, e, f, g, h;
            f = this.events, h = [];
            for (c in f) b = f[c], g = c.split(" "), d = 2 <= g.length ? q.call(g, 0, e = g.length - 1) : (e = 0, []), a = g[e++], h.push(this.addEvent(d.join(" "), a, b));
            return h
        ...
        return b = function() {
            ...
            for (a in b) {
                if (!r.call(b, a)) continue;
                c = b[a], d.push(a)
            }
            return d
        }(), "blur focus focusin focusout load resize scroll unload click dblclick\nmousedown mouseup mousemove mouseover mouseout mouseenter mouseleave\nchange select submit keydown keypress keyup error".split(/[^a-z]+/).concat(b)
    }(), d = {}, d.sniff = function(a) {
        return a.commonAncestorContainer != null ? new d.BrowserRange(a) : typeof a.start == "string" ? new d.SerializedRange(a) : a.start && typeof a.start == "object" ? new d.NormalizedRange(a) : (console.error(p("Could not sniff range type")), !1)
        ...
        return a.prototype.normalize = function(a) {
            ...
            if (this.tainted) return console.error(p("You may only call normalize() once on a BrowserRange!")), !1;
        ...
        return b.prototype._nodeFromXPath = function(b) {
            ...
            var c, e, f, g, h, i, j, k, l, m, n, o, q, r, s, t, u;
            ...
            if (!k.commonAncestorContainer) return console.error(p("Error deserializing range: can't find XPath '") + c + p("'. Is this the right document?")), null;
            t = ["start", "end"];
        ...
        return t(c, b), c.prototype.events = {
            ".annotator-adder button click": "onAdderClick",
            ".annotator-adder button mousedown": "onAdderMousedown" /*,".annotator-hl mouseover":"onHighlightMouseover"*/ ,
            ".annotator-hl mouseout": "startViewerHideTimer"
        }, c.prototype.html = {
            hl: '<span class="annotator-hl"></span>',
            adder: '<div class="annotator-adder"><button>' + p("Annotate") + "</button></div>",
            ...
            return this.viewer = new c.Viewer, this.viewer.hide().on("edit", this.onEditAnnotation).on("delete", this.onDeleteAnnotation).addField({
                load: function(c, d) {
                    return d.text ? a(c).escape(d.text) : a(c).html("<i>" + p("No Comment") + "</i>"), b.publish("annotationViewerTextField", [c, d])
                }
            ...
            var b, c, e, f;
            return f = h.getGlobal().getSelection(), e = [], f.isCollapsed || (e = function() {
                var a, e;
                e = [];
            ...
            for (i = 0, j = f.length; i < j; i++) {
                e = f[i];
                b.quote.push(a.trim(e.text()));
                b.ranges.push(e.serialize(this.wrapper[0], ".annotator-hl"));
                a.merge(b.highlights, this.highlightRange(e));
                $(b.highlights[0]).attr("data-annotation-id", b.id);
            }
            ...
            return this.plugins.Store ? this.plugins.Store.dumpAnnotations() : console.warn(p("Can't dump annotations without Store plugin."))
            ...
            return a && this.selectedRanges.length ? this.adder.css(h.mousePosition(a, this.wrapper[0])).show() : this.adder.hide()
            ...
            }), this.showViewer(a.makeArray(c), h.mousePosition(b, this.wrapper[0])))
        ...
        return t(b, a), b.prototype.pluginInit = function() {}, b
    }(c), b.$ = a, b.Delegator = c, b.Range = d, b._t = p, b.supported = function() {
        return function() {
            return !!this.getSelection
        }()
    }, b.noConflict = function() {
        return h.getGlobal().Annotator = i, this
        ...
        return t(d, c), d.prototype.classes = {
            hide: "annotator-hide",
            invert: {
            ...
            var b, c, d, e, f;
            return this.resetOrientation(), f = a(h.getGlobal()), e = this.element.children(":first"), c = e.offset(), d = {
                top: f.scrollTop(),
        ...
        return t(c, b), c.prototype.events = {
            ...
            var b;
            return h.preventEventDefault(a), this.element.removeClass(this.classes.hide), this.element.find(".annotator-save").addClass(this.classes.focus), this.checkOrientation(), b = this.isInvertedY() ? ":last" : ":first", this.element.find(":input" + b).focus(), this.publish("show")
        }, c.prototype.hide = function(a) {
            return h.preventEventDefault(a), this.element.addClass(this.classes.hide), this.publish("hide")
        ...
        function c(b) {
            this.onDeleteClick = s(this.onDeleteClick, this), this.onEditClick = s(this.onEditClick, this), this.load = s(this.load, this), this.hide = s(this.hide, this), this.show = s(this.show, this), c.__super__.constructor.call(this, a(this.html.element)[0], b), this.item = a(this.html.item)[0], this.fields = [], this.annotations = []
        }
        return t(c, b), c.prototype.events = {
            ...
            var b, c = this;
            return h.preventEventDefault(a), b = this.element.find(".annotator-controls").addClass(this.classes.showControls), setTimeout(function() {
        ...
        function d(b) {
            this.hide = s(this.hide, this), this.show = s(this.show, this), d.__super__.constructor.call(this, a(this.options.html).appendTo(document.body)[0], b)
        }
        return t(d, c), d.prototype.events = {
            click: "hide"
        }, d.prototype.options = {
